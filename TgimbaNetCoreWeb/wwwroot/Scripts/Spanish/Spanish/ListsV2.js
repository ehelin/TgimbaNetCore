...
function GetVerbsAR() {
    var verbs = "1,"
        + " to rent,"
        + " alquilar"
        + "<br/>Indicative_Preterite: alquilé alquilaste alquiló alquilamos alquilaron "
        + "<br/>Indicative_Imperfect: alquilaba alquilabas alquilaba alquilábamos alquilaban "
        + "<br/>Indicative_Present: alquilo alquilas alquila alquilamos alquilan "
        + "<br/>Indicative_Future: alquilaré alquilarás alquilará alquilaremos alquilarán;"

        + "2,"
        + " to disturb,"
        + " disturbar"
        + "<br/>Indicative_Preterite: disturbé disturbaste disturbó disturbamos disturbaron "
        + "<br/>Indicative_Imperfect: disturbaba disturbabas disturbaban disturbábamos disturbaban "
        + "<br/>Indicative_Present: disturbo disturbas disturba disturbamos disturban "
        + "<br/>Indicative_Future: disturbaré disturbarás disturbará disturbaremos disturbarán;"

        + "3,"
        + " to love ,"
        + " amar"
        + "<br/>Indicative_Preterite: amé amaste amó amamos amaron "
        + "<br/>Indicative_Imperfect: amaba amabas amaba amábamos amaban "
        + "<br/>Indicative_Present: amo amas ama amamos aman "
        + "<br/>Indicative_Future: amaré amarás amará amaremos amarán;"

        + "4,"
        + " to assemble,"
        + " armar"
        + "<br/>Indicative_Preterite: armé armaste armó armamos armaron "
        + "<br/>Indicative_Imperfect: armaba armabas armaba armábamos armaban "
        + "<br/>Indicative_Present: armo armas arma armamos arman "
        + "<br/>Indicative_Future: armaré armarás armará armaremos armarán;"
        ...
        + " to enroll,"
        + " anotar"
        + "<br/>Indicative_Preterite: anoté anotaste anotó anotamos anotaron "
        + "<br/>Indicative_Imperfect: anotaba anotabas anotaba anotábamos anotaban "
        + "<br/>Indicative_Present: anoto anotas anota anotamos anotan "
        + "<br/>Indicative_Future: anotaré anotarás anotará anotaremos anotarán;"
        ...
        + " to accept,"
        + " aceptar"
        + "<br/>Indicative_Preterite: acepté aceptaste aceptó aceptamos aceptaron "
        + "<br/>Indicative_Imperfect: aceptaba aceptabas aceptaba aceptábamos aceptaban "
        + "<br/>Indicative_Present: acepto aceptas acepta aceptamos aceptan "
        + "<br/>Indicative_Future: aceptaré aceptarás aceptará aceptaremos aceptarán;"
        ...
        + " to catch,"
        + " atrapar"
        + "<br/>Indicative_Preterite: atrapé atrapaste atrapó atrapamos atraparon "
        + "<br/>Indicative_Imperfect: atrapaba atrapabas atrapaba atrapábamos atrapaban "
        + "<br/>Indicative_Present: atrapo atrapas atrapa atrapamos atrapan "
        + "<br/>Indicative_Future: atraparé atraparás atrapará atraparemos atraparán;"

        + "11,"
        + "to adopt,"
        + "adoptar"
        + "<br/>Indicative_Preterite: adopté adoptaste adoptó adoptamos adoptaron "
        + "<br/>Indicative_Imperfect: adoptaba adoptabas adoptaba adoptábamos adoptaban "
        + "<br/>Indicative_Present: adopto adoptas adopta adoptamos adoptan "
        + "<br/>Indicative_Future: adoptaré adoptarás adoptará adoptaremos adoptarán;"

        + "12,"
        + "to help,"
        + "ayudar"
        + "<br/>Indicative_Preterite: ayudé ayudaste ayudó ayudamos ayudaron "
        + "<br/>Indicative_Imperfect: ayudaba ayudabas ayudaba ayudábamos ayudaban "
        + "<br/>Indicative_Present: ayudo ayudas ayuda ayudamos ayudan "
        + "<br/>Indicative_Future: ayudaré ayudarás ayudará ayudaremos ayudarán;"

        + "13,"
        + "to bath,"
        + "bañar"
        + "<br/>Indicative_Preterite: bañé bañaste bañó bañamos bañaron "
        + "<br/>Indicative_Imperfect: banaba banabas banaba bañábamos bañaban "
        + "<br/>Indicative_Present: baño banas baña bañamos bañan "
        + "<br/>Indicative_Future: bañaré bañarás bañará bañaremos bañarán ;"

        + "14,"
        + "to dance,"
        + "bailar"
        + "<br/>Indicative_Preterite: bailé bailaste bailó bailamos bailaron "
        + "<br/>Indicative_Imperfect: bailaba bailabas bailaba bailábamos bailaban "
        + "<br/>Indicative_Present: bailo bailas baila bailamos bailan "
        + "<br/>Indicative_Future: bailaré bailarás bailará bailaremos bailarán;"

        + "15,"
        + "to go down,"
        + "bajar"
        + "<br/>Indicative_Preterite: bajé bajaste bajo bajamos bajaron "
        + "<br/>Indicative_Imperfect: bajaba bajabas bajaba bajábamos bajaban "
        + "<br/>Indicative_Present: bajo bajas baja bajamos bajan "
        + "<br/>Indicative_Future: bajaré bajarás bajará bajaremos bajarán;"

        + "16,"
        + "to search,"
        + "buscar"
        + "<br/>Indicative_Preterite: busqué buscaste busco buscamos buscaron "
        + "<br/>Indicative_Imperfect: buscaba buscabas buscaba buscábamos buscaban "
        + "<br/>Indicative_Present: busco buscas busca buscamos buscan "
        + "<br/>Indicative_Future: buscaré buscarás buscará buscaremos buscarán;"

        + "17,"
        + "to walk ,"
        + "caminar"
        + "<br/>Indicative_Preterite: caminé caminaste camino caminamos caminaron "
        + "<br/>Indicative_Imperfect: caminaba caminabas caminaba caminábamos caminaban "
        + "<br/>Indicative_Present: camino caminas camina caminamos caminan "
        + "<br/>Indicative_Future: caminaré caminarás caminará caminaremos caminarán;"

        + "18,"
        + "to change,"
        + "cambiar"
        + "<br/>Indicative_Preterite: cambie cambiaste cambio cambiamos cambiaron "
        + "<br/>Indicative_Imperfect: cambiaba cambiabas cambiaba cambiábamos cambiaban "
        + "<br/>Indicative_Present: cambio cambias cambia cambiamos cambian "
        + "<br/>Indicative_Future: cambiaré cambiarás cambiará cambiaremos cambiarán;"

        + "19,"
        + "to cause,"
        + "causar"
        + "<br/>Indicative_Preterite: causé causaste causo causamos causaron "
        + "<br/>Indicative_Imperfect: causaba causabas causaba causábamos causaban "
        + "<br/>Indicative_Present: causo causas causa causamos causan "
        + "<br/>Indicative_Future: causaré causarás causará causaremos causarán;"

        + "20,"
        + "to cancel,"
        + "cancelar"
        + "<br/>Indicative_Preterite: cancelé cancelaste cancelo cancelamos cancelaron "
        + "<br/>Indicative_Imperfect: cancelaba cancelabas cancelaba cancelábamos cancelaban "
        + "<br/>Indicative_Present: cancelo cancelas cancela cancelamos cancelan "
        + "<br/>Indicative_Future: cancelaré cancelarás cancelará cancelaremos cancelarán;"

        + "21,"
        + "to sing,"
        + "cantar"
        + "<br/>Indicative_Preterite: canté cantaste canto cantamos cantaron "
        + "<br/>Indicative_Imperfect: cantaba cantabas cantaba cantábamos cantaban "
        + "<br/>Indicative_Present: canto cantas canta cantamos cantan "
        + "<br/>Indicative_Future: cantaré cantarás cantará cantaremos cantarán;"

        + "22,"
        + "to have dinner,"
        + "cenar"
        + "<br/>Indicative_Preterite: cené cenaste ceno cenamos cenaron "
        + "<br/>Indicative_Imperfect: cenaba cenabas cenaba cenábamos cenaban "
        + "<br/>Indicative_Present: ceno cenas cena cenamos cenan "
        + "<br/>Indicative_Future: cenaré cenarás cenará cenaremos cenarán;"
        ...
        + "to chat/talk,"
        + "charlar"
        + "<br/>Indicative_Preterite: charlé charlaste charlo charlamos charlaron "
        + "<br/>Indicative_Imperfect: charlaba charlabas charlaba charlábamos charlaban "
        + "<br/>Indicative_Present: charlo charlas charla charlamos charlan "
        + "<br/>Indicative_Future: charlaré charlarás charlará charlaremos charlarán;"

        + "25,"
        + "to cook,"
        + "cocinar"
        + "<br/>Indicative_Preterite: cociné cocinaste cocino cocinamos cocinaron "
        + "<br/>Indicative_Imperfect: cocinaba cocinabas cocinaba cocinábamos cocinaban "
        + "<br/>Indicative_Present: cocino cocinas cocina cocinamos cocinan "
        + "<br/>Indicative_Future: cocinaré cocinarás cocinará cocinaremos cocinarán;"

        + "26,"
        + "to buy,"
        + "comprar"
        + "<br/>Indicative_Preterite: compré compraste compró compramos compraron "
        + "<br/>Indicative_Imperfect: compraba comprabas compraba comprábamos compraban "
        + "<br/>Indicative_Present: compro compras compra compramos compran "
        + "<br/>Indicative_Future: compraré comprarás comprará compraremos comprarán;"

        + "27,"
        + "to put/place,"
        + "colocar"
        + "<br/>Indicative_Preterite: coloqué colocaste colocó colocamos colocaron "
        + "<br/>Indicative_Imperfect: colocaba colocabas colocaba colocábamos colocaban "
        + "<br/>Indicative_Present: coloco colocas coloca colocamos colocan "
        + "<br/>Indicative_Future: colocaré colocarás colocará colocaremos colocarán;"
        ...
        + "to talk,"
        + "conversar"
        + "<br/>Indicative_Preterite: conversé conversaste conversó conversamos conversaron "
        + "<br/>Indicative_Imperfect: conversaba conversabas conversaba conversábamos conversaban "
        + "<br/>Indicative_Present: converso conversas conversa conversamos conversan "
        + "<br/>Indicative_Future: conversaré conversarás conversará conversaremos conversarán;"

        + "30,"
        + "to consider,"
        + "considerar"
        + "<br/>Indicative_Preterite: consideré consideraste consideró consideramos consideraron "
        + "<br/>Indicative_Imperfect: consideraba considerabas consideraba considerábamos consideraban "
        + "<br/>Indicative_Present: considero consideras considera consideramos consideran "
        + "<br/>Indicative_Future: consideraré considerarás considerará consideraremos consideraremos considerarán;"

        + "31,"
        + "to answer,"
        + "contestar"
        + "<br/>Indicative_Preterite: contesté contestaste contestó contestamos contestaron "
        + "<br/>Indicative_Imperfect: contestaba contestabas contestaba contestábamos contestaban "
        + "<br/>Indicative_Present: contesto contestas contesta contestamos contestan "
        + "<br/>Indicative_Future: contestaré contestarás contestará contestaremos contestarán;"
        ...
        + "to cut,"
        + "cortar"
        + "<br/>Indicative_Preterite: corté cortaste cortó cortamos cortaron "
        ...
        + "<br/>Indicative_Future: cortaré cortarás cortará cortaremos cortarán;"

        + "35,"
        + "to create,"
        + "crear"
        + "<br/>Indicative_Preterite: creí creaste creó creamos crearon "
        + "<br/>Indicative_Imperfect: creaba creabas creaba creabamos creaban "
        + "<br/>Indicative_Present: creo creas crea creamos crean "
        + "<br/>Indicative_Future: crearé crearás creará crearemos crearán;"
        ...
        + "to allow,"
        + "dejar"
        + "<br/>Indicative_Preterite: dejé dejaste dejó dejamos dejaron "
        + "<br/>Indicative_Imperfect: dejaba dejabas dejaba dejábamos dejaban "
        + "<br/>Indicative_Present: dejo dejas deja dejamos dejan "
        + "<br/>Indicative_Future: dejaré dejarás dejará dejaremos dejarán;"

        + "38,"
        + "to spell,"
        + "deletrear"
        + "<br/>Indicative_Preterite: deletreé deletreaste deletreó deletreamos deletrearon "
        + "<br/>Indicative_Imperfect: deletreaba deletreabas deletreaba deletreábamos deletreaban "
        + "<br/>Indicative_Present: deletreo deletreas deletrea deletreamos deletrean "
        + "<br/>Indicative_Future: deletrearé deletrearás deletreará deletrearemos deletrearán;"
        ...
        + "to emphasize,"
        + "destacar"
        + "<br/>Indicative_Preterite: destaqué destacaste destacó destacamos destacaron "
        + "<br/>Indicative_Imperfect: destacaba destacabas destacaba destacábamos destacaban "
        + "<br/>Indicative_Present: destaco destacas destaca destacamos destacan "
        + "<br/>Indicative_Future: destacaré destacarás destacará destacaremos destacarán;"

        + "41,"
        + "to enjoy,"
        + "disfrutar"
        + "<br/>Indicative_Preterite: disfruté disfrutaste disfrutó disfrutamos disfrutaron "
        + "<br/>Indicative_Imperfect: disfrutaba disfrutabas disfrutaba disfrutábamos disfrutaban "
        + "<br/>Indicative_Present: disfruto disfrutas disfruta disfrutamos disfrutan "
        + "<br/>Indicative_Future: disfrutaré disfrutarás disfrutará disfrutaremos disfrutarán;"

        + "42,"
        + "to rest,"
        + "descansar"
        + "<br/>Indicative_Preterite: descansé descansaste descansó descansamos descansaron "
        + "<br/>Indicative_Imperfect: descansaba descansabas descansaba descansábamos descansaban "
        + "<br/>Indicative_Present: descanso descansas descansa descansamos descansan "
        + "<br/>Indicative_Future: descansaré descansarás descanscará descansaremos descansarán;"

        + "43,"
        + "to have breakfast,"
        + "desayunar"
        + "<br/>Indicative_Preterite: desayuné desayunaste desayunó desayunamos desayunaron "
        + "<br/>Indicative_Imperfect: desayunaba desayunabas desayunaba desayunábamos desayunban "
        + "<br/>Indicative_Present: desayuno desayunas desayuna desayunamos desayunan "
        + "<br/>Indicative_Future: desayunaré desayunarás desayunará desayunaremos desayunarán;"

        + "44,"
        + "to wish,"
        + "desear"
        + "<br/>Indicative_Preterite: deseé deseaste deseó deseamos desearon "
        + "<br/>Indicative_Imperfect: deseaba deseabas deseaba deseábamos deseaban "
        + "<br/>Indicative_Present: deseo deseas desea deseamos desean "
        + "<br/>Indicative_Future: desearé desearás deseará desearemos desearán;"

        + "45,"
        + "to draw,"
        + "dibujar"
        + "<br/>Indicative_Preterite: dibujé dibujaste dibujó dibujamos dibujaron "
        + "<br/>Indicative_Imperfect: dibujaba dibujabas dibujaba dibujábamos dibujaban "
        + "<br/>Indicative_Present: dibujo dibujas dibuja dibujamos dibujan "
        + "<br/>Indicative_Future: dibujaré dibujarás dibujará dibujaremos dibujarán;"

        + "46,"
        + "to praise,"
        + "elevar"
        + "<br/>Indicative_Preterite: elevé elevaste elevó elevamos elevaron "
        + "<br/>Indicative_Imperfect: elevaba elevabas elevaba elevábamos elevaban "
        + "<br/>Indicative_Present: elevo elevas eleva elevamos elevan "
        + "<br/>Indicative_Future: elevaré elevarás elevará elevaremos elevarán;"

        + "47,"
        + "to climb,"
        + "escalar"
        + "<br/>Indicative_Preterite: escalé escalaste escaló escalamos escalaron "
        + "<br/>Indicative_Imperfect: escalaba escalabas escalaba escalábamos escalaban "
        + "<br/>Indicative_Present: escalo escalas escala escalamos escalan "
        + "<br/>Indicative_Future: escalaré escalarás escalará escalaremos escalarán;"

        + "48,"
        + "to be sick,"
        + "enfermar"
        + "<br/>Indicative_Preterite: enfermé enfermaste enfermó enfermamos enfermaron "
        + "<br/>Indicative_Imperfect: enfermaba enfermabas enfermaba enfermábamos enfermaban "
        + "<br/>Indicative_Present: enfermo enfermas enferma enfermamos enferman "
        + "<br/>Indicative_Future: enfermaré enfermarás enfermará enfermaremos enfermarán;"

        + "49,"
        + "to enter,"
        + "entrar"
        + "<br/>Indicative_Preterite: entré entraste entró entramos entraron "
        ...
        + "<br/>Indicative_Future: entraré entrarás entrará entraremos entrarán;"

        + "50,"
        + "to send,"
        + "enviar"
        + "<br/>Indicative_Preterite: envié enviaste envió enviamos enviaron "
        + "<br/>Indicative_Imperfect: enviaba enviabas enviaba enviábamos enviaban "
        + "<br/>Indicative_Present: envío envías envía enviamos envían "
        + "<br/>Indicative_Future: enviaré enviarás enviará enviaremos enviarán;"
        ...
        + "to listen to,"
        + "escuchar"
        + "<br/>Indicative_Preterite: escuché escuchaste escuchó escuchamos escucharon "
        + "<br/>Indicative_Imperfect: escuchaba escuchabas escuchaba escuchábamos escuchaban "
        + "<br/>Indicative_Present: escucho escuchas escucha escuchamos escuchan "
        + "<br/>Indicative_Future: escucharé escucharás escuchará escucharemos escucharán;"

        + "53,"
        + "to teach,"
        + "enseñar"
        + "<br/>Indicative_Preterite: enseñé enseñaste enseñó enseñamos enseñaron "
        + "<br/>Indicative_Imperfect: enseñaba enseñabas enseñaba enseñábamos enseñaban "
        + "<br/>Indicative_Present: enseño enseñas enseña enseñamos enseñan "
        + "<br/>Indicative_Future: enseñaré enseñarás enseñará enseñaremos enseñarán;"
        ...
        + "to upset,"
        + "enojar"
        + "<br/>Indicative_Preterite: enojé enojaste enojó enojamos enojaron "
        ...
        + "<br/>Indicative_Future: enojaré enojarás enojará enojaremos enojarán;"

        + "56,"
        + "to hope,"
        + "esperar"
        + "<br/>Indicative_Preterite: esperé esperaste esperó esperamos esperaron "
        + "<br/>Indicative_Imperfect: esperaba esperabas esperaba esperábamos esperaban "
        + "<br/>Indicative_Present: espero esperas espera esperamos esperan "
        + "<br/>Indicative_Future: esperaré esperarás esperará esperaremos esperarán;"

        + "57,"
        + "to study,"
        + "estudiar"
        + "<br/>Indicative_Preterite: estudié estudiaste estudió estudiamos estudiaron "
        + "<br/>Indicative_Imperfect: estudiaba estudiabas estudiaba estudiábamos estudiaban "
        + "<br/>Indicative_Present: estudio estudias estudia estudiamos estudian "
        + "<br/>Indicative_Future: estudiaréestudiarás estudiará estudiaremos estudiarán;"
        ...
        + "to miss,"
        + "extrañar"
        + "<br/>Indicative_Preterite: extrañé extrañaste extrañó extrañamos extrañaron "
        + "<br/>Indicative_Imperfect: extrañaba extrañabas extrañaba extrañábamos extrañaban "
        + "<br/>Indicative_Present: extraño extrañas extraña extrañamos extrañan "
        + "<br/>Indicative_Future: extranaré extrañarás extrañará extrañaremos extrañarán;"

        + "60,"
        + "to explain,"
        + "explicar"
        + "<br/>Indicative_Preterite: expliqué explicaste explicó explicamos explicaron "
        + "<br/>Indicative_Imperfect: explicaba explicabas explicaba explicábamos explicaban "
        + "<br/>Indicative_Present: explico explicas explica explicamos explican "
        + "<br/>Indicative_Future: explicaré explicarás explicará explicaremos explicarán;"

        + "61,"
        + "to sign,"
        + "firmar"
        + "<br/>Indicative_Preterite: firmé firmaste firmó firmamos firmaron "
        + "<br/>Indicative_Imperfect: firmaba firmabas firmaba firmábamos firmaban "
        + "<br/>Indicative_Present: firmo firmas firma firmamos firman "
        + "<br/>Indicative_Future: firmaré firmarás firmará firmaremos firmarán;"

        + "62,"
        + "to finish,"
        + "finalizar"
        + "<br/>Indicative_Preterite: finalicé finalizaste finalizó finalizamos finalizaron "
        + "<br/>Indicative_Imperfect: finalizaba finalizabas finalizaba finalizábamos finalizaban "
        + "<br/>Indicative_Present: finalizo finalizas finaliza finalizamos finalizan "
        + "<br/>Indicative_Future: finalizaré finalizarás finalizará finalizaremos finalizarán;"

        + "63,"
        + "to smoke,"
        + "fumar"
        + "<br/>Indicative_Preterite: fumé fumaste fumó fumamos fumaron "
        + "<br/>Indicative_Imperfect: fumaba fumabas fumaba fumábamos fumaban "
        + "<br/>Indicative_Present: fumo fumas fuma fumamos fuman "
        + "<br/>Indicative_Future: fumaré fumarás fumará fumaremos fumarán;"

        + "64,"
        + "to win,"
        + "ganar"
        + "<br/>Indicative_Preterite: gané ganaste ganó ganamos ganaron "
        + "<br/>Indicative_Imperfect: ganaba ganabas ganaba ganábamos ganaban "
        + "<br/>Indicative_Present: gano ganas gana ganamos ganan "
        + "<br/>Indicative_Future: ganaré ganarás ganará ganaremos ganarán;"

        + "65,"
        + "to spend money,"
        + "gastar"
        + "<br/>Indicative_Preterite: gasté gastaste gastó gastamos gastaron "
        + "<br/>Indicative_Imperfect: gastaba gastabas gastaba gastábamos gastaban "
        + "<br/>Indicative_Present: gasto gastas gasta gastamos gastan "
        + "<br/>Indicative_Future: gastaré gastarás gastará gastaremos gastarán;"

        + "66,"
        + "to like,"
        + "gustar"
        + "<br/>Indicative_Preterite: gusté gustaste gustó gustamos gustaron "
        + "<br/>Indicative_Imperfect: gustaba gustabas gustaba gustábamos gustaban "
        + "<br/>Indicative_Present: gusto gustas gusta gustamos gustan "
        + "<br/>Indicative_Future: gustaré gustarás gustará gustaremos gustarán;"

        + "67,"
        + "to talk,"
        + "hablar"
        + "<br/>Indicative_Preterite: hablé hablaste habló hablamos hablaron "
        + "<br/>Indicative_Imperfect: hablaba hablabas hablaba hablábamos hablaban "
        + "<br/>Indicative_Present: hablo hablas habla hablamos hablan "
        + "<br/>Indicative_Future: hablaré hablarás hablará hablaremos hablarán;"

        + "68,"
        + "to motivate,"
        + "impulsar"
        + "<br/>Indicative_Preterite: impulsé impulsaste impulsó impulsamos impulsaron "
        + "<br/>Indicative_Imperfect: impulsaba impulsabas impulsaba impulsábamos impulsaban "
        + "<br/>Indicative_Present: impulso impulsas impulsa impulsamos impulsan "
        + "<br/>Indicative_Future: impulsaré impulsarás impulsará impulsaremos impulsarán;"

        + "69,"
        + "to try,"
        + "intentar"
        + "<br/>Indicative_Preterite: intenté intentaste intentó intentamos intentaron "
        + "<br/>Indicative_Imperfect: intentaba intentabas intentaba intentábamos intentaban "
        + "<br/>Indicative_Present: intento intentas intenta intentamos intentan "
        + "<br/>Indicative_Future: intentaré intentarás intentará intentaremos intentarán;"

        + "70,"
        + "to insinuate/hint,"
        + "insinuar"
        + "<br/>Indicative_Preterite: insinué insinuaste insinuó insinuamos insinuaron "
        + "<br/>Indicative_Imperfect: insinuaba insinuabas insinuaba insinuábamos insinuaban "
        + "<br/>Indicative_Present: insinuo insinuas insinua insinuamos insinuan "
        + "<br/>Indicative_Future: insinuaré insinuarás insinuará insinuaremos insinuarán;"

        + "71,"
        + "to start,"
        + "iniciar"
        + "<br/>Indicative_Preterite: inicié iniciaste inició iniciamos iniciaron "
        + "<br/>Indicative_Imperfect: iniciaba iniciabas iniciaba iniciábamos iniciaban "
        + "<br/>Indicative_Present: inicio inicias inicia iniciamos inician "
        + "<br/>Indicative_Future: iniciaré iniciarás iniciará iniciaremos iniciarán;"
        ...
        + "to wash ,"
        + "lavar"
        + "<br/>Indicative_Preterite: lavé lavaste lavó lavamos lavaron "
        + "<br/>Indicative_Imperfect: lavaba lavabas lavaba lavábamos lavaban "
        + "<br/>Indicative_Present: lavo lavas lava lavamos lavan "
        + "<br/>Indicative_Future: lavaré lavarás lavará lavaremos lavarán;"

        + "74,"
        + "to call,"
        + "llamar"
        + "<br/>Indicative_Preterite: llamé llamaste llamó llamamos llamaron "
        + "<br/>Indicative_Imperfect: llamaba llamabas llamaba llamábamos llamaban "
        + "<br/>Indicative_Present: llamo llamas llama llamamos llaman "
        + "<br/>Indicative_Future: llamaré llamarás llamará llamaremos llamarán;"

        + "75,"
        + "to clean,"
        + "limpiar"
        + "<br/>Indicative_Preterite: limpié limpiaste limpió limpiamos limpiaron "
        + "<br/>Indicative_Imperfect: limpiaba limpiabas limpiaba limpiábamos limpiaban "
        + "<br/>Indicative_Present: limpio limpias limpia limpiamos limpian "
        + "<br/>Indicative_Future: limpiaré limpiarás limpiará limpiaremos limpiarán;"

        + "76,"
        + "to arrive,"
        + "llegar"
        + "<br/>Indicative_Preterite: llegué llegaste llegó llegamos llegaron "
        + "<br/>Indicative_Imperfect: llegaba llegabas llegaba llegábamos llegaban "
        + "<br/>Indicative_Present: llego llegas llega llegamos llegan "
        + "<br/>Indicative_Future: llegaré llegarás llegara llegaremos llegarán;"

        + "77,"
        + "to fill,"
        + "llenar"
        + "<br/>Indicative_Preterite: llené llenaste llenó llenamos llenaron "
        + "<br/>Indicative_Imperfect: llenaba llenabas llenaba llenábamos llenaban "
        + "<br/>Indicative_Present: lleno llenas llena llenamos llenan "
        + "<br/>Indicative_Future: llenaré llenarás llenará llenaremos llenarán;"

        + "78,"
        + "to wear to carry ,"
        + "llevar"
        + "<br/>Indicative_Preterite: llevé llevaste llevó llevamos llevaron "
        + "<br/>Indicative_Imperfect: llevaba llevabas llevaba llevábamos llevaban "
        + "<br/>Indicative_Present: llevo llevas lleva llevamos llevan "
        + "<br/>Indicative_Future: llevaré llevarás llevará llevaremos llevarán;"

        + "79,"
        + "to achieve,"
        + "lograr"
        + "<br/>Indicative_Preterite: logré lograste logró logramos lograron "
        + "<br/>Indicative_Imperfect: lograba lograbas lograba lográbamos lograban "
        + "<br/>Indicative_Present: logra logras logra logramos logran "
        + "<br/>Indicative_Future: lograré lograras logrará lograremos lograrán;"

        + "80,"
        + "to order ,"
        + "mandar"
        + "<br/>Indicative_Preterite: mandé mandaste mandó mandamos mandaron "
        + "<br/>Indicative_Imperfect: mandaba mandabas mandaba mandábamos mandaban "
        + "<br/>Indicative_Present: mando mandas manda mandamos mandan "
        + "<br/>Indicative_Future: mandaré mandarás mandará mandaremos mandarán;"

        + "81,"
        + "to dwell,"
        + "morar"
        + "<br/>Indicative_Preterite: moré moraste moró moramos moraron "
        + "<br/>Indicative_Imperfect: moraba morabas moraba morábamos moraban "
        + "<br/>Indicative_Present: moro moras mora moramos moran "
        + "<br/>Indicative_Future: moraré morarás morará moraremos morarán;"
        ...
        + "to watch look at ,"
        + "mirar"
        + "<br/>Indicative_Preterite: miré miraste miró miramos miraron "
        + "<br/>Indicative_Imperfect: miraba mirabas miraba mirábamos miraban "
        + "<br/>Indicative_Present: miro miras mira miramos miran "
        + "<br/>Indicative_Future: miraré mirarás mirará miraremos mirarán;"
        ...
        + "to need ,"
        + "necesitar"
        + "<br/>Indicative_Preterite: necesité necesitaste necesitó necesitamos necesitaron "
        ...
        + "<br/>Indicative_Future: necesitaré necesitarás necesitará necesitaremos necesitarán;"

        + "86,"
        + "to swim,"
        + "nadar"
        + "<br/>Indicative_Preterite: nadé nadaste nadó nadamos nadaron "
        + "<br/>Indicative_Imperfect: nadaba nadabas nadaba nadábamos nadaban "
        + "<br/>Indicative_Present: nado nadas nada nadamos nadan "
        + "<br/>Indicative_Future: nadaré nadarás nadará nadaremos nadarán;"

        + "87,"
        + "to forget,"
        + "olvidar"
        + "<br/>Indicative_Preterite: olvidé olvidaste olvidó olvidamos olvidaron "
        + "<br/>Indicative_Imperfect: olvidaba olvidabas olvidaba olvidábamos olvidaban "
        + "<br/>Indicative_Present: olvido olvidas olvida olvidamos olvidan "
        + "<br/>Indicative_Future: olvidaré olvidarás olvidará olvidaremos olvidarán;"

        + "88,"
        + "to organize,"
        + "organizar"
        + "<br/>Indicative_Preterite: organicé organizaste organizó organizamos organizaron "
        + "<br/>Indicative_Imperfect: organizaba organizabas organizaba organizábamos organizaban "
        + "<br/>Indicative_Present: organizo organizas organiza organizamos organizan "
        + "<br/>Indicative_Future: organizaré organizarás organizará organizaremos organizarán;"

        + "89,"
        + "to comb,"
        + "peinar"
        + "<br/>Indicative_Preterite: peiné peinaste peinó peinamos peinaron "
        + "<br/>Indicative_Imperfect: peinaba peinabas peinaba peinábamos peinaban "
        + "<br/>Indicative_Present: peino peinas peina peinamos peinan "
        + "<br/>Indicative_Future: peinaré peinarás peinará peinaremos peinarán;"

        + "90,"
        + "to pay for,"
        + "pagar"
        + "<br/>Indicative_Preterite: pagué pagaste pagó pagamos pagaron "
        + "<br/>Indicative_Imperfect: pagaba pagabas pagaba pagábamos pagaban "
        + "<br/>Indicative_Present: pago pagas paga pagamos pagan "
        + "<br/>Indicative_Future: pagaré pagarás pagará pagaremos pagarán;"

        + "91,"
        + "to practice,"
        + "practicar"
        + "<br/>Indicative_Preterite: practiqué practicaste practicó practicamos practicaron "
        + "<br/>Indicative_Imperfect: practicaba practicabas practicaba practicábamos practicaban "
        + "<br/>Indicative_Present: practico practicas practica practicamos practican "
        + "<br/>Indicative_Future: practicaré practicarás practicará practicaremos practicarán;"

        + "92,"
        + "to ask for,"
        + "preguntar"
        + "<br/>Indicative_Preterite: pregunté preguntaste preguntó preguntamos preguntaron "
        + "<br/>Indicative_Imperfect: preguntaba preguntabas preguntaba preguntábamos preguntaban "
        + "<br/>Indicative_Present: pregunto preguntas pregunta preguntamos preguntan "
        + "<br/>Indicative_Future: preguntaré preguntarás preguntará preguntaremos preguntarán;"

        + "93,"
        + "to press,"
        + "presionar"
        + "<br/>Indicative_Preterite: presioné presionaste presionó presionamos presionaron "
        + "<br/>Indicative_Imperfect: presionaba presionabas presionaba presionábamos presionaban "
        + "<br/>Indicative_Present: presiono presionas presiona presionamos presionan "
        + "<br/>Indicative_Future: presionaré presionarás presionará presionaremos presionarán;"

        + "94,"
        + "to speak,"
        + "platicar"
        + "<br/>Indicative_Preterite: platiqué platicaste platicó platicamos platicaron "
        + "<br/>Indicative_Imperfect: platicaba platicabas platicaba platicábamos platicaban "
        + "<br/>Indicative_Present: platico platicas platica platicamos platican "
        + "<br/>Indicative_Future: platicaré platicarás platicará platicaremos platicarán;"

        + "95,"
        + "to prepare,"
        + "preparar"
        + "<br/>Indicative_Preterite: preparé preparaste preparo preparamos preparan "
        + "<br/>Indicative_Imperfect: preparaba preparabas preparaba preparábamos preparaban "
        + "<br/>Indicative_Present: preparo preparas prepara preparemos preparan "
        + "<br/>Indicative_Future: prepararé prepararás preparará prepararemos prepararán;"
        ...
        + "to pronounce,"
        + "pronunciar"
        + "<br/>Indicative_Preterite: pronuncié pronunciaste pronunció pronuncamos pronunciaron "
        + "<br/>Indicative_Imperfect: pronunciaba pronunciabas pronunciaba pronunciábamos pronunciaban "
        + "<br/>Indicative_Present: pronuncio pronuncias pronuncia pronunciamos pronuncian "
        + "<br/>Indicative_Future: pronunciaré pronunciarás pronunciará pronunciaremos pronunciarán;"

        + "98,"
        + "to borrow,"
        + "prestar"
        + "<br/>Indicative_Preterite: presté prestaste prestó prestamos prestaron "
        + "<br/>Indicative_Imperfect: prestaba prestabas prestaban prestabámos prestaban "
        + "<br/>Indicative_Present: presto prestas presta prestamos prestan "
        + "<br/>Indicative_Future: prestaré prestarás prestará prestaremos prestarán;"

        + "99,"
        + "to pass,"
        + "pasar"
        + "<br/>Indicative_Preterite: pasé pasaste pasó pasamos pasaron "
        + "<br/>Indicative_Imperfect: pasaba pasabas pasaba pasábamos pasaban "
        + "<br/>Indicative_Present: paso pasas pasa pasamos pasan "
        + "<br/>Indicative_Future: pasaré pasarás pasará pasaremos pasarán;"

        + "100,"
        + "to remove ,"
        + "quitar"
        + "<br/>Indicative_Preterite: quité quitaste quitó quitamos quitaron "
        + "<br/>Indicative_Imperfect: quitaba quitabas quitaba quitábamos quitaban "
        + "<br/>Indicative_Present: quito quitas quita quitamos quitan "
        + "<br/>Indicative_Future: quitaré quitarás quitará quitaremos quitarán;"

        + "101,"
        + "to give,"
        + "regalar"
        + "<br/>Indicative_Preterite: regalé regalaste regaló regalamos regalaron "
        + "<br/>Indicative_Imperfect: regalaba regalabas regalaba regalábamos regalaban "
        + "<br/>Indicative_Present: regalo regalas regala regalamos regalan "
        + "<br/>Indicative_Future: regalaré regalarás regalará regalaremos regalarán;"

        + "102,"
        + "to return,"
        + "regresar"
        + "<br/>Indicative_Preterite: regresé regresaste regresó regresamos regresaron "
        + "<br/>Indicative_Imperfect: regresaba regresabas regresaba regresábamos regresaban "
        + "<br/>Indicative_Present: regreso regresas regresa regresamos regresan "
        + "<br/>Indicative_Future: regresaré regresarás regresará regresaremos regresarán;"

        + "103,"
        + "to fix,"
        + "reparar"
        + "<br/>Indicative_Preterite: reparé reparaste reparó reparamos repararon "
        + "<br/>Indicative_Imperfect: reparaba reparabas reparaba reparábamos reparaban "
        + "<br/>Indicative_Present: reparo reparas repara reparamos reparan "
        + "<br/>Indicative_Future: repararé repararás reparará repararemos repararán;"
        ...
        + "to greet,"
        + "saludar"
        + "<br/>Indicative_Preterite: saludé saludaste saludó saludamos saludaron "
        + "<br/>Indicative_Imperfect: saludaba saludabas saludaba saludábamos saludaban "
        + "<br/>Indicative_Present: saludo saludas saluda saludamos saludan "
        + "<br/>Indicative_Future: saludaré saludarás saludará saludaremos saludarán;"
        ...
        + "tocar"
        + "<br/>Indicative_Preterite: toqué tocaste tocó tocamos tocaron "
        + "<br/>Indicative_Imperfect: tocaba tocabas tocaba tocábamos tocaban "
        + "<br/>Indicative_Present: toco tocas toca tocamos tocan "
        + "<br/>Indicative_Future: tocaré tocarás tocará tocaremos tocarán;"

        + "109,"
        + "to take drink,"
        + "tomar"
        + "<br/>Indicative_Preterite: tomé tomaste tomó tomamos tomaron "
        + "<br/>Indicative_Imperfect: tomaba tomabas tomaba tomábamos tomaban "
        + "<br/>Indicative_Present: tomo tomas toma tomamos toman "
        + "<br/>Indicative_Future: tomaré tomarás tomará tomaremos tomarán;"

        + "110,"
        + "to finish,"
        + "terminar"
        + "<br/>Indicative_Preterite: terminé terminaste terminó terminamos terminaron "
        + "<br/>Indicative_Imperfect: terminaba terminabas terminaba terminábamos terminaban "
        + "<br/>Indicative_Present: termino terminas termina terminamos terminan "
        + "<br/>Indicative_Future: terminaré terminarás terminará terminaremos terminarán;"

        + "111,"
        + "to work,"
        + "trabajar"
        + "<br/>Indicative_Preterite: trabajé trabajaste trabajó trabajamos trabajaron "
        + "<br/>Indicative_Imperfect: trabajaba trabajabas trabajaba trabajábamos trabajaban "
        + "<br/>Indicative_Present: trabajo trabajas trabaja trabajamos trabajan "
        + "<br/>Indicative_Future: trabajaré trabajarás trabajará trabajaremos trabajarán;"

        + "112,"
        + "to pull,"
        + "tirar"
        + "<br/>Indicative_Preterite: tiré tiraste tiró tiramos tiraron "
        + "<br/>Indicative_Imperfect: tiraba tirabas tiraba tirábamos tiraban "
        + "<br/>Indicative_Present: tiro tiras tira tiramos tiran "
        + "<br/>Indicative_Future: tiraré tirarás tirará tiraremos tirarán;"

        + "113,"
        + "to treat,"
        + "tratar"
        + "<br/>Indicative_Preterite: traté trataste trató tratamos trataron "
        + "<br/>Indicative_Imperfect: trataba tratabas trataba tratábamos trataban "
        + "<br/>Indicative_Present: trato tratas trata tratamos tratan "
        + "<br/>Indicative_Future: trataré tratarás tratará trataremos tratarán;"

        + "114,"
        + "to use,"
        + "utilizar"
        + "<br/>Indicative_Preterite: utilicé utilizaste utilizó utilizamos utilizaron "
        + "<br/>Indicative_Imperfect: utilizaba utilizabas utilizaba utilizábamos utilizaban "
        + "<br/>Indicative_Present: utilizo utilizas utiliza utilizamos utilizan "
        + "<br/>Indicative_Future: utilizaré utilizarás utilizará utilizaremos utilizáran;"

        + "115,"
        + "to use,"
        + "usar"
        + "<br/>Indicative_Preterite: usé usaste usó usamos usaron "
        + "<br/>Indicative_Imperfect: usaba usabas usaba usábamos usaban "
        + "<br/>Indicative_Present: uso usas usa usamos usan "
        + "<br/>Indicative_Future: usaré usarás usará usaremos usarán;"

        + "116,"
        + "to travel,"
        + "viajar"
        + "<br/>Indicative_Preterite: viajé viajaste viajó viajamos viajaron "
        + "<br/>Indicative_Imperfect: viajaba viajabas viajaba viajábamos viajaban "
        + "<br/>Indicative_Present: viajo viajas viaja viajamos viajan "
        + "<br/>Indicative_Future: viajaré viajarás viajará viajaremos viajarán;"

        + "117,"
        + "to visit,"
        + "visitar"
        + "<br/>Indicative_Preterite: visité visitaste visitó visitamos visitaron "
        + "<br/>Indicative_Imperfect: visitaba visitabas visitaba visitábamos visitaban "
        + "<br/>Indicative_Present: visito visitas visita visitamos visitan "
        + "<br/>Indicative_Future: visitaré visitarás visitará visitaremos visitarán;"
...
function GetVerbsER() {
    var verbs = "1,"
        + "to learn,"
        + "aprender"
        + "<br/>Indicative_Preterite: aprendí aprendiste aprendió aprendimos aprenderion "
        + "<br/>Indicative_Imperfect: aprendia aprendias aprendia aprendíamos aprendian "
        + "<br/>Indicative_Present: aprendo aprendes aprende aprendemos aprenden "
        + "<br/>Indicative_Future: aprenderé aprenderás aprenderá aprenderemos aprenderán;"
        ...
        + "to drink,"
        + "beber"
        + "<br/>Indicative_Preterite: bebí bebiste bebió bebimos bebieron "
        + "<br/>Indicative_Imperfect: bebia bebias bebia bebíamos bebian "
        + "<br/>Indicative_Present: bebo bebes bebe bebemos beben "
        + "<br/>Indicative_Future: beberé beberás beberá beberemos beberán;"
        ...
        + "to eat,"
        + "comer"
        + "<br/>Indicative_Preterite: comí comiste comió comimos comieron "
        + "<br/>Indicative_Imperfect: comia comias comia comíamos comian "
        + "<br/>Indicative_Present: como comes come comemos comen "
        + "<br/>Indicative_Future: comeré comerás comerá comeremos comerán;"

        + "7,"
        + "to understand,"
        + "comprender"
        + "<br/>Indicative_Preterite: comprendí  comprendiste comprendió comprendimos comprendieron "
        + "<br/>Indicative_Imperfect: comprendia comprendias comprendia comprendíamos comprendian "
        + "<br/>Indicative_Present: comprendo comprendes comprende comprendemos comprendan "
        + "<br/>Indicative_Future: comprenderé comprenderás comprenderá comprenderemos comprenderán;"

        + "8,"
        + "to run,"
        + "correr"
        + "<br/>Indicative_Preterite: corrí  corriste corrió corrimos corrieron "
        + "<br/>Indicative_Imperfect: corria corrias corria corríamos corrian "
        + "<br/>Indicative_Present: corro corres corre corremos corren "
        + "<br/>Indicative_Future: correré correrás correrá correremos correrán;"

        + "9,"
        + "to believe,"
        + "creer"
        + "<br/>Indicative_Preterite: creí  creiste creyó creimos creyeron "
        + "<br/>Indicative_Imperfect: creia creias creia creíamos creian "
        + "<br/>Indicative_Present: creo crees cree cremos creen "
        + "<br/>Indicative_Future: creeré creerás creerá creeremos creerán;"
        ...
        + "to owe,"
        + "deber"
        + "<br/>Indicative_Preterite: debí  debiste debió debimos debieron "
        + "<br/>Indicative_Imperfect: debia debias debia debíamos debian "
        + "<br/>Indicative_Present: debo debes debe debemos deben "
        + "<br/>Indicative_Future: deberé deberás deberá deberemos deberán;"

        + "12,"
        + "to hide,"
        + "esconder"
        + "<br/>Indicative_Preterite: escondí escondiste escondió escondimos escondieron "
        + "<br/>Indicative_Imperfect: escondia escondias escondia escondíamos escondian "
        + "<br/>Indicative_Present: escondo escondes esconde escondemos esconden "
        + "<br/>Indicative_Future: esconderé esconderás esconderá esconderemos esconderán;"
        ...
        + "to read,"
        + "leer"
        + "<br/>Indicative_Preterite: leí leiste leyó leimos leyeron "
        + "<br/>Indicative_Imperfect: leia leias leia leíamos leian "
        + "<br/>Indicative_Present: leo lees lee leemos leen "
        + "<br/>Indicative_Future: leeré leerás leerá leeremos leerán;"

        + "19,"
        + "to put,"
        + "meter"
        + "<br/>Indicative_Preterite: metí metiste metió metimos metieron "
        + "<br/>Indicative_Imperfect: metia metias metia metíamos metian "
        + "<br/>Indicative_Present: meto metas meta metamos metan "
        + "<br/>Indicative_Future: meteré meterás meterá meteremos meterán;"
        ...
        + "to pretend,"
        + "pretender"
        + "<br/>Indicative_Preterite: pretendí pretendiste pretendió pretendimos pretendieron "
        + "<br/>Indicative_Imperfect: pretendia pretendias pretendia pretendíamos pretendian "
        + "<br/>Indicative_Present: pretendo pretendes pretende pretendemos pretenden "
        + "<br/>Indicative_Future: pretenderé pretenderás pretenderá pretenderemos pretenderán;"

        + "24,"
        + "to possess to own,"
        + "poseer"
        + "<br/>Indicative_Preterite: poseí poseiste poseyó poseimos poseyeron "
        + "<br/>Indicative_Imperfect: poseia poseias poseia poseíamos poseian "
        + "<br/>Indicative_Present: poseo posees posee poseemos poseen "
        + "<br/>Indicative_Future: poseeré poseerás poseerá poseeremos poseerán;"
        ...
        + "to promise,"
        + "prometer"
        + "<br/>Indicative_Preterite: prometí prometiste prometió prometimos prometieron "
        + "<br/>Indicative_Imperfect: prometia prometias prometia prometíamos prometian "
        + "<br/>Indicative_Present: prometo prometes promete prometemos prometen "
        + "<br/>Indicative_Future: prometeré prometerás prometerá prometeremos prometerán;"
        ...
        + "to reply,"
        + "responder"
        + "<br/>Indicative_Preterite: respondí respondiste respondió respondimos respondieron "
        + "<br/>Indicative_Imperfect: respondia respondias respondia respondíamos respondian "
        + "<br/>Indicative_Present: respondo respondes responde respondemos responden "
        + "<br/>Indicative_Future: responderé responderás responderá responderemos responderán;"

        + "31,"
        + "to break,"
        + "romper"
        + "<br/>Indicative_Preterite: rompí  rompiste rompió rompimos rompieron "
        + "<br/>Indicative_Imperfect: rompia rompias rompia rompíamos rompian "
        + "<br/>Indicative_Present: rompo rompes rompe rompemos rompen "
        + "<br/>Indicative_Future: romperé romperás romperá romperemos romperán;"
        ...
        + "to fear,"
        + "temer"
        + "<br/>Indicative_Preterite: temí temiste temio temimos temieron "
        + "<br/>Indicative_Imperfect: temia temias temia temíamos temian "
        + "<br/>Indicative_Present: temo temes teme tememos temen "
        + "<br/>Indicative_Future: temeré temerás temerá temeremos temerán;"

        + "36,"
        + "to cough,"
        + "toser"
        + "<br/>Indicative_Preterite: tosí  tosiste tosió tosimos tosieron "
        + "<br/>Indicative_Imperfect: tosia tosias tosia tosíamos tosian "
        + "<br/>Indicative_Present: toso toses tose tosemos tosen "
        + "<br/>Indicative_Future: toseré toserás toserá toseremos toserán;"

        + "37,"
        + "to bring,"
        + "traer"
        + "<br/>Indicative_Preterite: traje trajiste trajo trajimos trajeron "
        + "<br/>Indicative_Imperfect: traia traias traia traíamos traian "
        + "<br/>Indicative_Present: traigo traes trae traemos traen "
        + "<br/>Indicative_Future: traeré traerás traerá traeremos traerán;"
        ...
        + "to sell,"
        + "vender"
        + "<br/>Indicative_Preterite: vendí vendiste vendió vendimos vendieron "
        + "<br/>Indicative_Imperfect: vendia vendias vendia vendíamos vendian "
        + "<br/>Indicative_Present: vendo vendes vende vendemos venden "
        + "<br/>Indicative_Future: venderé venderás venderá venderemos venderán;"
...
function GetVerbsIR() {
    var verbs = "1,"
        + "to open,"
        + "abrir"
        + "<br/>Indicative_Preterite: abrí abriste abrió abrimos abrieron "
        + "<br/>Indicative_Imperfect: abria abrias abria abríamos  abrian "
        + "<br/>Indicative_Present: abro abres abre abrimos abren "
        + "<br/>Indicative_Future: abriré abrirás abrirá abriremos abrirán;"

        + "2,"
        + "to admit,"
        + "admitir"
        + "<br/>Indicative_Preterite: admití  admitiste admitió admitimos admitieron "
        + "<br/>Indicative_Imperfect: admitia admitias admitia admitíamos admitian "
        + "<br/>Indicative_Present: admito admites admite admitimos admiten "
        + "<br/>Indicative_Future: admitiré admitirás admitirá admitiremos admitirán;"

        + "3,"
        + "to attend,"
        + "asistir"
        + "<br/>Indicative_Preterite: asistí asististe asistió asistimos asistieron "
        + "<br/>Indicative_Imperfect: asistia asistias asistia asistíamos asistian "
        + "<br/>Indicative_Present: asisto asistes asistes asistimos asisten "
        + "<br/>Indicative_Future: asistiré asistirás asistirá asistiremos asistirán;"

        + "4,"
        + "to cover,"
        + "cubrir"
        + "<br/>Indicative_Preterite: cubrí cubriste cubrió cubrimos cubrieron "
        + "<br/>Indicative_Imperfect: cubria cubrias cubria cubríamos cubrian "
        + "<br/>Indicative_Present: cubrio cubries cubrie cubrimos cubren "
        + "<br/>Indicative_Future: cubriré cubrirás cubrirá cubriremos cubrirán;"

        + "5,"
        + "to achieve,"
        + "cumplir"
        + "<br/>Indicative_Preterite: cumplí cumpliste cumplió cumplimos cumplieron "
        + "<br/>Indicative_Imperfect: cumplia cumplias cumplia cumplíamos cumplian "
        + "<br/>Indicative_Present: cumplo cumples cumple cumplimos cumplen "
        + "<br/>Indicative_Future: cumpliré cumplirás cumplirá cumpliremos cumplirán;"
        ...
        + "to decide,"
        + "decidir"
        + "<br/>Indicative_Preterite: decidí decidiste decidió decidimos decidieron "
        + "<br/>Indicative_Imperfect: decidia decidias decidia decidíamos decidian "
        + "<br/>Indicative_Present: decido decides decide decidimos deciden "
        + "<br/>Indicative_Future: decidiré decidirás decidirá decidiremos decidirán;"

        + "9,"
        + "to describe, "
        + "describir"
        + "<br/>Indicative_Preterite: describí  describiste describió describimos describieron "
        + "<br/>Indicative_Imperfect: describia describias describia describíamos describian "
        + "<br/>Indicative_Present: describo describes describe describimos describen "
        + "<br/>Indicative_Future: describiré describirás describirá describiremos describirán;"
        ...
        + "to discover,"
        + "descubrir"
        + "<br/>Indicative_Preterite: descubrí descubriste descubrió descubrimos descubrieron "
        + "<br/>Indicative_Imperfect: descubria descubrias descubria descubríamos descubrian "
        + "<br/>Indicative_Present: descubro descubres descubre descubrimos descubren "
        + "<br/>Indicative_Future: descubriré descurbrirás descurbrirá descurbriamos descubrirán;"

        + "12,"
        + "to argue,"
        + "discutir"
        + "<br/>Indicative_Preterite: discutí discutiste discutió discutimos discutieron "
        + "<br/>Indicative_Imperfect: discutia discutias discutia discutíamos discutian "
        + "<br/>Indicative_Present: discuto discutes discute discutimos discuten "
        + "<br/>Indicative_Future: discutiré discutirás discutirá discutiremos discutirán;"

        + "13,"
        + "to write,"
        + "escribir"
        + "<br/>Indicative_Preterite: escribí escribiste escribió escribimos escribieron "
        + "<br/>Indicative_Imperfect: escribia escribias escribia escribíamos escribian "
        + "<br/>Indicative_Present: escribo escribes escribe escribimos escriben "
        + "<br/>Indicative_Future: escribiré escribirás escribirá escribiremos escribirán;"
        ...
        + "to print,"
        + "imprimir"
        + "<br/>Indicative_Preterite: imprimí imprimiste imprimió imprimimos imprimieron "
        + "<br/>Indicative_Imperfect: imprimia imprimias imprimia imprimíamos imprimian "
        + "<br/>Indicative_Present: imprimo imprimes imprime imprimimos imprimen "
        + "<br/>Indicative_Future: imprimiré imprimirás imprimirá imprimiremos imprimirán;"
        ...
        + "to omit,"
        + "omitir"
        + "<br/>Indicative_Preterite: omití omitiste omitió omitimos omitieron "
        + "<br/>Indicative_Imperfect: omitia omitias omitia omitíamos omitian "
        + "<br/>Indicative_Present: omito omitas omita omitimos omiten "
        + "<br/>Indicative_Future: omitiré omitirás omitirá omitiremos omitirá;"

        + "23,"
        + "to divide,"
        + "partir"
        + "<br/>Indicative_Preterite: partí partiste partió partimos partieron "
        + "<br/>Indicative_Imperfect: partia partias partia partíamos partian "
        + "<br/>Indicative_Present: parto partes parte partimos parten "
        + "<br/>Indicative_Future: partiré partirá s partirá  partiremos partirán;"

        + "24,"
        + "to forbid,"
        + "prohibir"
        + "<br/>Indicative_Preterite: prohibí  prohibiste prohibió prohibimos prohibieron "
        + "<br/>Indicative_Imperfect: prohibia prohibias prohibia prohibíamos prohibian "
        + "<br/>Indicative_Present: prohibo prohibes prohibe prohibimos prohiben "
        + "<br/>Indicative_Future: prohibiré prohibirás prohibirá  prohibiremos prohibirán;"
        ...
        + "to permit,"
        + "permitir"
        + "<br/>Indicative_Preterite: permití permitiste permitió permitimos permitieron "
        ...
        + "<br/>Indicative_Future: permitiré permiterás permitirá permitiremos permitirán;"
        ...
        + "to receive,"
        + "recibir"
        + "<br/>Indicative_Preterite: recibí recibiste recibió recibimos recibieron "
        + "<br/>Indicative_Imperfect: recibia recibias recibia recibíamos recibian "
        + "<br/>Indicative_Present: recibo recibes recibe recibimos reciben "
        + "<br/>Indicative_Future: recibiré recibiras recibira recibiremos recibiran;"

        + "29,"
        + "to repeat,"
        + "repetir"
        + "<br/>Indicative_Preterite: repetí repetiste repitió repetimos repitieron "
        + "<br/>Indicative_Imperfect: repetia repetias repetia repetíamos repetian "
        + "<br/>Indicative_Present: repito repites repite repetimos repiten "
        + "<br/>Indicative_Future: repetiré repetirás repetirá repetiremos repetirán;"
        ...
        + "to climb,"
        + "subir"
        + "<br/>Indicative_Preterite: subí subiste subió subimos subieron "
        + "<br/>Indicative_Imperfect: subia subias subia subíamos subian "
        + "<br/>Indicative_Present: subo subes sube subimos suben "
        + "<br/>Indicative_Future: subiré subirás subirá subiremos subirán;"

        + "35,"
        + "to suffer,"
        + "sufrir"
        + "<br/>Indicative_Preterite: sufrí sufriste sufrió sufrimos sufrieron "
        + "<br/>Indicative_Imperfect: sufria sufrias sufria sufríamos sufrian "
        + "<br/>Indicative_Present: sufro sufres sufre sufremos sufren "
        + "<br/>Indicative_Future: sufriré sufrirás sufrirá sufriremos sufrirán;"
        ...
        + "to unite,"
        + "unir"
        + "<br/>Indicative_Preterite: uní uniste unió unimos unieron "
        + "<br/>Indicative_Imperfect: unia unias unia uníamos unian "
        + "<br/>Indicative_Present: uno unes une unimos unen "
        + "<br/>Indicative_Future: uniré uniras unirá uniremos unirán;"

        + "38,"
        + "to live,"
        + "vivir"
        + "<br/>Indicative_Preterite: viví  viviste vivió vivimos vivieron "
        + "<br/>Indicative_Imperfect: vivia vivias vivia vivíamos vivian "
        + "<br/>Indicative_Present: vivo vives vive vivimos viven "
        + "<br/>Indicative_Future: viviré vivirás vivirá viviremos vivirán;"
